...
/***/ "./src/app/storage/file-navigation.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileNavigationService; });
...
var FileNavigationService = /** @class */ (function () {
    function FileNavigationService() {
        this.navigation = new Queue();
        this.navigation.setRoot({ directory: 'Root', link: '#' });
        this.filenames = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](this.navigation.getItems().map(function (item) { return item.directory; }));
    }
    FileNavigationService.prototype.navigate = function (newPage) {
        // check if the back is a back navigation
        if (!this.navigation.getItems().filter(function (page) { return page.directory === newPage.directory; })) {
            console.log('Page already on navigation stack');
            var ind = this.navigation.getItems().indexOf(newPage);
            this.navigation.setRoot(this.navigation.takeFirst());
            var items = this.navigation.getItems().slice(1, ind);
            (_a = this.navigation).push.apply(_a, items);
            this.filenames.next(this.navigation.getItems().map(function (item) { return item.directory; }));
        }
        this.navigation.push(newPage);
        this.filenames.next(this.navigation.getItems().map(function (item) { return item.directory; }));
        console.log('Current Stack: ');
        console.log(this.navigation.getItems());
        var _a;
    };
    FileNavigationService.prototype.checkIfInStack = function (page) {
        this.navigation.getItems().includes(page);
    };
    FileNavigationService.prototype.goBack = function () {
        this.navigation.pop();
    };
    Object.defineProperty(FileNavigationService.prototype, "active", {
        get: function () {
            return this.navigation.takeLast();
        },
        enumerable: true,
        configurable: true
    });
    FileNavigationService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [])
    ], FileNavigationService);
    return FileNavigationService;
}());

var FileTreeItem = /** @class */ (function () {
...
var Queue = /** @class */ (function () {
    ...
    Queue.prototype.push = function () {
        ...
        return (_a = this.items).push.apply(_a, item);
        var _a;
    };
    Queue.prototype.takeFirst = function () {
        return this.items[0];
    };
    Queue.prototype.takeLast = function () {
        return this.items[this.items.length - 1];
    };
    Queue.prototype.getItems = function () {
        return this.items;
    };
    Queue.prototype.setRoot = function (root) {
        this.items = [];
        this.push(root);
        return this;
    };
...
/***/ "./src/app/storage/size-formatter.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SizeFormatterPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SizeFormatterPipe = /** @class */ (function () {
    function SizeFormatterPipe() {
    }
    /**
     *
     * @param value number to be formatted. Defaults to in megabytes unless specified
     * @param args does not use args at the moment
     */
    SizeFormatterPipe.prototype.transform = function (value, args) {
        if (args === 'B') {
            value = value / 1024 / 1024; // Now in MB
        }
        else if (args === 'KB') {
            value = value / 1024; // Now in MB
        }
        else if (args === 'GB') {
            value = value * 1024;
        }
    ...
    SizeFormatterPipe = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["T" /* Pipe */])({
            name: 'sizeFormatter'
        })
    ], SizeFormatterPipe);
    return SizeFormatterPipe;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__upload_upload_component__ = __webpack_require__("./src/app/storage/upload/upload.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__upload_upload_service__ = __webpack_require__("./src/app/storage/upload/upload.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__storage_storage_component__ = __webpack_require__("./src/app/storage/storage/storage.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__size_formatter_pipe__ = __webpack_require__("./src/app/storage/size-formatter.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__file_navigation_service__ = __webpack_require__("./src/app/storage/file-navigation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__storage_service__ = __webpack_require__("./src/app/storage/storage.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'upload', component: __WEBPACK_IMPORTED_MODULE_4__upload_upload_component__["a" /* UploadComponent */] },
    { path: '', component: __WEBPACK_IMPORTED_MODULE_6__storage_storage_component__["a" /* StorageComponent */] }
];
var StorageModule = /** @class */ (function () {
    ...
    StorageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_4__upload_upload_component__["a" /* UploadComponent */], __WEBPACK_IMPORTED_MODULE_6__storage_storage_component__["a" /* StorageComponent */], __WEBPACK_IMPORTED_MODULE_7__size_formatter_pipe__["a" /* SizeFormatterPipe */]],
            providers: [
                __WEBPACK_IMPORTED_MODULE_5__upload_upload_service__["a" /* UploadService */],
                __WEBPACK_IMPORTED_MODULE_8__file_navigation_service__["a" /* FileNavigationService */],
...
/***/ "./src/app/storage/storage/storage.component.css":
...
/***/ "./src/app/storage/storage/storage.component.html":
/***/ (function(module, exports) {

module.exports = "\n<div class=\"container-fluid\">\n\n  <!-- file list card -->\n    \n    <!-- breadcrum navigation for use with folders -->\n    <nav aria-label=\"file-tree\">\n        <ol class=\"breadcrumb\">\n          <li class=\"breadcrumb-item\" *ngFor=\"let dir of navStackFileNames\"><a href=\"#\">{{ dir }}</a></li>\n        </ol>\n    </nav>\n\n    <ul class=\"list-group list-group-flush\">\n      <!-- header -->\n      <li class=\"list-group-item list-group-item-dark\">\n          <strong>Name</strong>\n          <span class=\"float-right\">\n            <strong>Date</strong>\n          </span>\n        </li>\n\n      <div *ngFor=\"let file of files\">\n      <li class=\"list-group-item\"  (click)=\"navigateFolder(file)\">\n        <i class=\"fas fa-file\"></i> {{ file.fileName }}\n        <span class=\"float-right\">\n          {{ file.uploadDate | date: 'short' }}\n        </span>\n      </li>\n      </div>\n    </ul>\n\n\n    <pre>\n      {{ navStackFileNames }}\n      {{ files }}\n    </pre>\n</div>"

/***/ }),

/***/ "./src/app/storage/storage/storage.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StorageComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__file_navigation_service__ = __webpack_require__("./src/app/storage/file-navigation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__storage_service__ = __webpack_require__("./src/app/storage/storage.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var testData = [
    { filename: 'blah.mp4', size: 124 },
    { filename: 'tron.avi', size: 1765 },
    { filename: 'short-song.mp4', size: 74 },
    { filename: 'agola.mp4', size: 125 },
    { filename: 'quan.mp4', size: 139 },
    { filename: 'simple-times.mp4', size: .574 },
    { filename: 'rocknroll.mp4', size: 185 },
    { filename: 'itsthenewsong.mp4', size: 123 },
    { filename: 'theanglesong.mp4', size: 165 },
    { filename: 'ineedahero.mp4', size: 137 },
    { filename: 'heros.mp4', size: 198 }
];
var navigationStack = [
    { directory: 'root', link: '#' },
    { directory: 'SYSTEM', link: '#' },
    { directory: 'clib64', link: '#' },
    { directory: 'sys-audio', link: '#' }
];
var StorageComponent = /** @class */ (function () {
    function StorageComponent(fileNavigator, storageService) {
        this.fileNavigator = fileNavigator;
        this.storageService = storageService;
    }
    StorageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.storageService.getAll().subscribe(function (resp) {
            _this.files = resp;
            console.log(resp);
        });
        this.fileNavigator.filenames.subscribe(function (names) { return _this.navStackFileNames = names; }, function (err) { return console.log(err); });
    };
    StorageComponent.prototype.navigateFolder = function (toNav) {
        console.log(toNav);
        var addFolder = new FileTreeItem();
        addFolder.directory = toNav.filename;
        addFolder.link = '#';
        this.fileNavigator.navigate(addFolder);
    };
    StorageComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-storage',
            template: __webpack_require__("./src/app/storage/storage/storage.component.html"),
            styles: [__webpack_require__("./src/app/storage/storage/storage.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__file_navigation_service__["a" /* FileNavigationService */],
            __WEBPACK_IMPORTED_MODULE_2__storage_service__["a" /* StorageService */]])
    ], StorageComponent);
    return StorageComponent;
}());

var FileDisplay = /** @class */ (function () {
...
/***/ "./src/app/storage/upload/upload.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/storage/upload/upload.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\n\n  <h1>File Upload</h1>\n\n  <div>\n    <i class=\"fas fa-circle text-success\"></i> Free\n    <i class=\"fas fa-circle text-warning ml-3\"></i> Used\n\n    <small *ngIf=\"quota.loaded\" class=\"float-right text-muted\">{{ quota.total | sizeFormatter: 'B'}} Total</small>\n  </div>\n  <div class=\"progress\" *ngIf=\"quota.loaded\">\n    <div class=\"progress-bar bg-success\" [style.width.%]=\"getPercent(quota.free, quota.total)\">{{ getPercent(quota.free, quota.total) }}% ({{ quota.free | sizeFormatter: 'B' }})</div>\n    <div class=\"progress-bar bg-warning\" [style.width.%]=\"getPercent(quota.used, quota.total)\">{{ getPercent(quota.used, quota.total) }}% ({{ quota.used | sizeFormatter: 'B' }})</div>\n  </div>\n\n  <form class=\"my-4\" #uploadForm=\"ngForm\" (ngSubmit)=\"submit()\" *ngIf=\"!isSubmitted\">\n    <div class=\"form-group\">\n      <label for=\"file-name\">File Name</label>\n      <input name=\"fileName\" [(ngModel)]=\"fileName\" type=\"text\" class=\"form-control\" id=\"file-name\" placeholder=\"file\">\n      <small id=\"file-name-helpBlock\" class=\"form-text text-muted\">\n          Give your file a name to be used for saving on your storage.\n      </small>\n    </div>\n    <div class=\"form-group\">\n      <div class=\"custom-file\">\n        <input name=\"file\" (change)=\"onFileChange($event)\" [(ngModel)]=\"file\" type=\"file\" class=\"custom-file-input\" id=\"customFile\">\n        <label *ngIf=\"file\" class=\"custom-file-label\" for=\"customFile\">{{ file.name }}</label>\n        <label *ngIf=\"!file\" class=\"custom-file-label\" for=\"customFile\">Choose file...</label>\n      </div>\n      <small id=\"fileHelpBlock\" class=\"form-text text-muted\">\n          Only file types of avf, aaf, apf, or aef are supported for upload.\n      </small>\n    </div>\n\n    <button type=\"submit\" class=\"btn btn-primary-gradient float-right\">Upload</button>\n  </form>\n\n  <!-- progress bar -->\n  <div *ngIf=\"isSubmitted\" class=\"my-4\">\n    <h4 *ngIf=\"!uploadComplete\">Uploading...</h4>\n    <h4 *ngIf=\"uploadComplete\">Upload Complete</h4>\n    <div class=\"progress\">\n      <div *ngIf=\"!uploadComplete\" class=\"progress-bar progress-bar-striped progress-bar-animated bg-info\" [style.width.%]=\"percent\">{{ percent }}%</div>\n      <div *ngIf=\"uploadComplete\" class=\"progress-bar progress-bar-striped bg-info\" [style.width.%]=\"percent\">{{ percent }}%</div>\n    </div>\n    <button (click)=\"resetForm()\" *ngIf=\"uploadComplete\" class=\"mt-4 btn btn-primary-gradient float-right\">Upload Another</button>\n  </div>\n\n</div>\n"

/***/ }),

/***/ "./src/app/storage/upload/upload.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UploadComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__upload_service__ = __webpack_require__("./src/app/storage/upload/upload.service.ts");
...
var UploadComponent = /** @class */ (function () {
    function UploadComponent(uploadService) {
        ...
        this.quota = { total: 0, used: 0, free: 0, loaded: false };
    }
    UploadComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.uploadService.getQuota('user').subscribe(function (resp) {
            _this.quota.total = resp.memoryLimit;
            _this.quota.used = resp.memoryAmount;
            _this.quota.free = resp.memoryLimit - resp.memoryAmount;
            _this.quota.loaded = true;
    ...
    UploadComponent.prototype.getPercent = function (currentFileSize, totalFileSize) {
        console.log('Dividing ' + currentFileSize + ' / ' + totalFileSize);
        console.log(currentFileSize / totalFileSize);
        var blah = Math.round((currentFileSize / totalFileSize) * 100);
        console.log('Rounded to ' + blah);
        return blah;
    };
    UploadComponent.prototype.submit = function () {
        var _this = this;
        console.log('Submitting form');
        this.uploadService.post(this.file, this.fileName)
            .subscribe(function (ev) {
            _this.fileProgress(ev);
            _this.isSubmitted = true;
        }, function (err) { return console.log(err); }, function () {
            _this.quota.free -= _this.file.size;
            _this.quota.used += _this.file.size;
        });
    };
    UploadComponent.prototype.resetForm = function () {
    ...
    UploadComponent.prototype.fileProgress = function (event) {
        // progress
        if (event.type === __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["e" /* HttpEventType */].UploadProgress) {
            console.log(event.loaded, event.total);
            // event.loaded = bytes transfered
            // event.total = "Content-Length", set by the server
            this.percent = Math.round(100 / event.total * event.loaded);
        }
        // finished
        if (event.type === __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["e" /* HttpEventType */].Response) {
    ...
    UploadComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-upload',
            template: __webpack_require__("./src/app/storage/upload/upload.component.html"),
            styles: [__webpack_require__("./src/app/storage/upload/upload.component.css")]
        }),
...
/***/ "./src/app/storage/upload/upload.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var UploadService = /** @class */ (function () {
    function UploadService(http) {
        this.http = http;
        this.API_URL = '/api/file/test';
    }
    UploadService.prototype.post = function (file, fileName) {
        var formData = new FormData();
        formData.append('file', file, fileName);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["f" /* HttpHeaders */]();
        headers = headers.delete('Content-Type');
        return this.http.post(this.API_URL, formData, { headers: headers, reportProgress: true, observe: 'events' });
    };
    UploadService.prototype.postBody = function (file, fileName) {
        this.http
            .post(this.API_URL, file).subscribe();
    };
    UploadService.prototype.getQuota = function (username) {
        return this.http.get('/api/quotas/' + username);
    };
...
//# sourceMappingURL=storage.module.chunk.js.map